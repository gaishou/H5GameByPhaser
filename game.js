...
var levelState = {
    ...
    create: function(){
        ...
        // add return button
        this.return_button = new ButtonPrefab(game.world.width - 16,
            game.world.height - 16, 'return', levelState.returnCallback, this);
...
function Character(data, panel, mapx, mapy, type){
    //characters有僵尸猪 蝙蝠王 幽灵 牛头怪 洋葱头玩家
    this.panel = panel;
    this.type = type;
    ...
    // 角色的states: stand, walking_left, walking_right, walking_up, walking_down
    this.state = 'stand';
